  ...
  int chartFileNumber, const char* specsCksum, int_T method, void *data)
{
  ...
  if (chartFileNumber==26) {
    c26_hybridSysSim_method_dispatcher(simstructPtr, method, data);
    return 1;
  }
  ...
  int nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"machine")) {
      ...
      ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2195494753U);
      ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3015988974U);
      ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(4251939587U);
      ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(367771399U);
       ...
       case 26:
        {
          ...
          sf_c26_hybridSysSim_get_check_sum(plhs);
          break;
        }
    ...
    ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1929268288U);
    ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1572625327U);
    ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1339864889U);
    ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2833053451U);
  }
  ...
  int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     ...
     case 2:
      {
        if (strcmp(aiChksum, "K2gGzhpqOlD88r9Qiv8mXF") == 0) {
     ...
     case 9:
      {
        if (strcmp(aiChksum, "2tJTO7Ng12BRODHFkubQ7G") == 0) {
     ...
     case 11:
      {
        if (strcmp(aiChksum, "lbq5XFlJCfRwGmu85NYfkF") == 0) {
     ...
     case 16:
      {
        if (strcmp(aiChksum, "2PsHbBKyjTHYa95WdubRfH") == 0) {
     ...
     case 19:
      {
        if (strcmp(aiChksum, "TyEJIgb708116eTKtTe52B") == 0) {
     ...
     case 20:
      {
        if (strcmp(aiChksum, "38TcD5KSPOHlcpW6H8Ck7C") == 0) {
     ...
     case 25:
      {
        if (strcmp(aiChksum, "5SU3ZBswaNmXlCJoV5BLuE") == 0) {
     ...
     case 26:
      {
        if (strcmp(aiChksum, "kaFld4w1mrGpnzF3wt940E") == 0) {
          extern mxArray *sf_c26_hybridSysSim_get_autoinheritance_info(void);
          plhs[0] = sf_c26_hybridSysSim_get_autoinheritance_info();
          break;
        }
...

  {
    ...
    switch (chartFileNumber) {
     ...
     case 26:
      {
        extern const mxArray
          *sf_c26_hybridSysSim_get_eml_resolved_functions_info(void);
        mxArray *persistentMxArray = (mxArray *)
          sf_c26_hybridSysSim_get_eml_resolved_functions_info();
        plhs[0] = mxDuplicateArray(persistentMxArray);
        mxDestroyArray(persistentMxArray);
        break;
      }
  ...
  int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     ...
     case 2:
      {
        if (strcmp(tpChksum, "5rJZI0BABUiRSGXTOBqukD") == 0) {
     ...
     case 9:
      {
        if (strcmp(tpChksum, "ZBb94EYUnKcIit3vgicPBB") == 0) {
     ...
     case 11:
      {
        if (strcmp(tpChksum, "Wgcokw81hywJzj8hf9nLHC") == 0) {
     ...
     case 16:
      {
        if (strcmp(tpChksum, "sTr9ttozaVID2amWEjGoNG") == 0) {
     ...
     case 19:
      {
        if (strcmp(tpChksum, "X1nX2UjrmTGL5OUf5Y3mYH") == 0) {
     ...
     case 20:
      {
        if (strcmp(tpChksum, "8SU1t3D5E4uGNHkYVG7Y5E") == 0) {
     ...
     case 25:
      {
        if (strcmp(tpChksum, "A0A33CuYlV9gUJevsOtaBF") == 0) {
     ...
     case 26:
      {
        if (strcmp(tpChksum, "PpzwZC6G8DVZAAMBxZGViE") == 0) {
          extern mxArray *sf_c26_hybridSysSim_third_party_uses_info(void);
          plhs[0] = sf_c26_hybridSysSim_third_party_uses_info();
          break;
        }
      }
...

  {
    ...
    switch (chartFileNumber) {
     ...
     case 26:
      {
        if (strcmp(tpChksum, "PpzwZC6G8DVZAAMBxZGViE") == 0) {
          extern mxArray *sf_c26_hybridSysSim_jit_fallback_info(void);
          plhs[0] = sf_c26_hybridSysSim_jit_fallback_info();
          break;
        }
      }
...

  {
    ...
    switch (chartFileNumber) {
     ...
     case 26:
      {
        if (strcmp(tpChksum, "PpzwZC6G8DVZAAMBxZGViE") == 0) {
          extern mxArray *sf_c26_hybridSysSim_updateBuildInfo_args_info(void);
          plhs[0] = sf_c26_hybridSysSim_updateBuildInfo_args_info();
          break;
        }
      }
  ...
  const mxArray * prhs[] )
{
  ...
  switch (chartFileNumber) {
   ...
   case 26:
    {
      if (strcmp(tpChksum, "PpzwZC6G8DVZAAMBxZGViE") == 0) {
        extern mxArray *sf_c26_hybridSysSim_get_post_codegen_info(void);
        plhs[0] = sf_c26_hybridSysSim_get_post_codegen_info();
        return;
      }
    }
    break;
