...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2823987118U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(543297804U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(999178244U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2506327951U);
}
...
mxArray *sf_c2_hybridSysSim_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("K2gGzhpqOlD88r9Qiv8mXF");
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",704,-1,3657);
        _SFD_CV_INIT_EML_FCN(0,1,"rotMat",3666,-1,3937);
...
static void mdlSetWorkWidths_c2_hybridSysSim(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(639804248U));
  ssSetChecksum1(S,(1530320063U));
  ssSetChecksum2(S,(1679074080U));
  ssSetChecksum3(S,(941574341U));
