  ...
  *chartInstance)
{
  ...
  int32_T c2_i40;
  int32_T c2_i41;
  static real_T c2_d_a[4] = { -0.055, 0.0, 0.0, -0.25 };
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2511752387U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1973661397U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3730084493U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1351360228U);
}
...
mxArray *sf_c2_hybridSysSim_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("IUJ8av8Hd444a0FOZbitHB");
...
static void mdlSetWorkWidths_c2_hybridSysSim(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2053975526U));
  ssSetChecksum1(S,(2361407654U));
  ssSetChecksum2(S,(3966774229U));
  ssSetChecksum3(S,(1775014840U));
