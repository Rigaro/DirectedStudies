...
static const char * c10_debug_family_names[7] = { "nargin", "nargout", "urk",
  "m", "g", "r", "tk" };

/* Function Declarations */
static void initialize_c10_hybridSysSim(SFc10_hybridSysSimInstanceStruct
  *chartInstance);
static void initialize_params_c10_hybridSysSim(SFc10_hybridSysSimInstanceStruct *
  chartInstance);
static void enable_c10_hybridSysSim(SFc10_hybridSysSimInstanceStruct
  *chartInstance);
static void disable_c10_hybridSysSim(SFc10_hybridSysSimInstanceStruct
  *chartInstance);
static void c10_update_debugger_state_c10_hybridSysSim
...
static void finalize_c10_hybridSysSim(SFc10_hybridSysSimInstanceStruct
  *chartInstance);
static void sf_gateway_c10_hybridSysSim(SFc10_hybridSysSimInstanceStruct
  *chartInstance);
static void mdl_start_c10_hybridSysSim(SFc10_hybridSysSimInstanceStruct
  *chartInstance);
static void initSimStructsc10_hybridSysSim(SFc10_hybridSysSimInstanceStruct
  *chartInstance);
...
static real_T c10_b_emlrt_marshallIn(SFc10_hybridSysSimInstanceStruct
...
static const mxArray *c10_b_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static int32_T c10_c_emlrt_marshallIn(SFc10_hybridSysSimInstanceStruct
  *chartInstance, const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
...
static uint8_T c10_d_emlrt_marshallIn(SFc10_hybridSysSimInstanceStruct
  *chartInstance, const mxArray *c10_b_is_active_c10_hybridSysSim, const char_T *
  c10_identifier);
static uint8_T c10_e_emlrt_marshallIn(SFc10_hybridSysSimInstanceStruct
  *chartInstance, const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
static void init_dsm_address_info(SFc10_hybridSysSimInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc10_hybridSysSimInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c10_is_active_c10_hybridSysSim = 0U;
}
...
static void c10_info_helper(const mxArray **c10_info)
{
  ...
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.p"), "resolved",
                  "resolved", 0);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(1410778848U), "fileTimeLo",
                  "fileTimeLo", 0);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 0);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(1369981086U), "mFileTimeLo",
                  "mFileTimeLo", 0);
  ...
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/shared/coder/coder/+coder/+internal/assert.m"),
                  "resolved", "resolved", 1);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(1389681774U), "fileTimeLo",
                  "fileTimeLo", 1);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 1);
  ...
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m"), "resolved",
                  "resolved", 2);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(1363677880U), "fileTimeLo",
                  "fileTimeLo", 2);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 2);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/shared/coder/coder/+coder/+internal/isBuiltInNumeric.m"),
                  "resolved", "resolved", 3);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(1395895856U), "fileTimeLo",
                  "fileTimeLo", 3);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 3);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_scalexp_compatible.m"),
                  "resolved", "resolved", 4);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(1286786396U), "fileTimeLo",
                  "fileTimeLo", 4);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 4);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_div.m"), "resolved",
                  "resolved", 5);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(1386387952U), "fileTimeLo",
                  "fileTimeLo", 5);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 5);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/div.p"), "resolved",
                  "resolved", 6);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(1410778970U), "fileTimeLo",
                  "fileTimeLo", 6);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 6);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(0U), "mFileTimeLo",
...
static void init_simulink_io_address(SFc10_hybridSysSimInstanceStruct
  *chartInstance)
{
  chartInstance->c10_urk = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 0);
  chartInstance->c10_tk = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 1);
  chartInstance->c10_m = (real_T *)ssGetInputPortSignal_wrapper(chartInstance->S,
    1);
  chartInstance->c10_g = (real_T *)ssGetInputPortSignal_wrapper(chartInstance->S,
    2);
  chartInstance->c10_r = (real_T *)ssGetInputPortSignal_wrapper(chartInstance->S,
    3);
}
...
void sf_c10_hybridSysSim_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(798291281U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2565399472U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(311226328U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3796229062U);
}

mxArray* sf_c10_hybridSysSim_get_post_codegen_info(void);
mxArray *sf_c10_hybridSysSim_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("BmERL23eliMdsyagqpQLi");
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c10_hybridSysSim_get_post_codegen_info();
...
mxArray *sf_c10_hybridSysSim_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c10_hybridSysSim_jit_fallback_info(void)
{
...
mxArray *sf_c10_hybridSysSim_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c10_hybridSysSim(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"tk\",},{M[8],M[0],T\"is_active_c10_hybridSysSim\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c10_hybridSysSim_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc10_hybridSysSimInstanceStruct *)
      ...
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          sf_debug_set_chart_event_thresholds(sfGlobalDebugInstanceStruct,
            ...
            0,
            0);
          _SFD_SET_DATA_PROPS(0,1,1,0,"urk");
          _SFD_SET_DATA_PROPS(1,2,0,1,"tk");
        ...
        _SFD_SET_DATA_COMPILED_PROPS(4,SF_DOUBLE,0,NULL,0,0,0,0.0,1.0,0,0,
          (MexFcnForType)c10_sf_marshallOut,(MexInFcnForType)NULL);
        _SFD_SET_DATA_VALUE_PTR(0U, chartInstance->c10_urk);
        _SFD_SET_DATA_VALUE_PTR(1U, chartInstance->c10_tk);
        _SFD_SET_DATA_VALUE_PTR(2U, chartInstance->c10_m);
        _SFD_SET_DATA_VALUE_PTR(3U, chartInstance->c10_g);
        _SFD_SET_DATA_VALUE_PTR(4U, chartInstance->c10_r);
      }
    } else {
...
{
  return "AyshRuYrHCq7DTRoTcEzr";
}

static void sf_opaque_initialize_c10_hybridSysSim(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc10_hybridSysSimInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c10_hybridSysSim((SFc10_hybridSysSimInstanceStruct*)
    chartInstanceVar);
  initialize_c10_hybridSysSim((SFc10_hybridSysSimInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c10_hybridSysSim(void *chartInstanceVar)
{
  enable_c10_hybridSysSim((SFc10_hybridSysSimInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c10_hybridSysSim(void *chartInstanceVar)
{
  disable_c10_hybridSysSim((SFc10_hybridSysSimInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c10_hybridSysSim(void *chartInstanceVar)
{
  sf_gateway_c10_hybridSysSim((SFc10_hybridSysSimInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c10_hybridSysSim(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c10_hybridSysSim((SFc10_hybridSysSimInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c10_hybridSysSim(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c10_hybridSysSim((SFc10_hybridSysSimInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c10_hybridSysSim(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc10_hybridSysSimInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c10_hybridSysSim((SFc10_hybridSysSimInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc10_hybridSysSim((SFc10_hybridSysSimInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c10_hybridSysSim(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c10_hybridSysSim(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(1681184757U));
  ssSetChecksum1(S,(240785470U));
  ssSetChecksum2(S,(3612106683U));
  ssSetChecksum3(S,(2219789068U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c10_hybridSysSim(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c10_hybridSysSim(SimStruct *S)
{
  SFc10_hybridSysSimInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc10_hybridSysSimInstanceStruct *)utMalloc(sizeof
    (SFc10_hybridSysSimInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc10_hybridSysSimInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c10_hybridSysSim;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c10_hybridSysSim;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c10_hybridSysSim;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c10_hybridSysSim;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c10_hybridSysSim;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c10_hybridSysSim;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c10_hybridSysSim;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c10_hybridSysSim;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c10_hybridSysSim;
  chartInstance->chartInfo.mdlStart = mdlStart_c10_hybridSysSim;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c10_hybridSysSim;
...
void c10_hybridSysSim_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c10_hybridSysSim(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c10_hybridSysSim(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c10_hybridSysSim(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c10_hybridSysSim_method_dispatcher.\n"
