  ...
  int nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
    ...
    ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3967237154U);
    ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3839563894U);
    ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(4230602272U);
    ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2435743298U);
  }
  ...
  int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     ...
     case 2:
      {
        if (strcmp(aiChksum, "IUJ8av8Hd444a0FOZbitHB") == 0) {
     ...
     case 20:
      {
        if (strcmp(aiChksum, "ZJrFWH3rp2Y3OfC2S2s6YB") == 0) {
  ...
  int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     ...
     case 2:
      {
        if (strcmp(tpChksum, "B8kC5iodkEQ7KkhyGIF4OG") == 0) {
     ...
     case 20:
      {
        if (strcmp(tpChksum, "bMIEnrpc3ONup0ZtoUwweG") == 0) {
