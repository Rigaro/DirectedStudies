...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2436105322U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1551368576U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2547949532U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1157850762U);
}
...
mxArray *sf_c20_hybridSysSim_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("ZJrFWH3rp2Y3OfC2S2s6YB");
...
static void mdlSetWorkWidths_c20_hybridSysSim(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2212262401U));
  ssSetChecksum1(S,(3105540216U));
  ssSetChecksum2(S,(1424789939U));
  ssSetChecksum3(S,(2655065873U));
