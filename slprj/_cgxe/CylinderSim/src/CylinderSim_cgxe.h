#ifndef __CylinderSim_cgxe_h__
#define __CylinderSim_cgxe_h__
...
extern unsigned int cgxe_CylinderSim_method_dispatcher(SimStruct* S, int_T
  method, void* data);
extern int cgxe_CylinderSim_autoInfer_dispatcher(const mxArray* prhs, mxArray*
  lhs[], const char* commandName);
extern void cgxe_CylinderSim_initializer(void);
extern void cgxe_CylinderSim_terminator(void);
