...
static Finger_2 *Finger_Finger(InstanceStruct_gNahLr7d449KlyI8HQN75D
  *moduleInstance, Finger_2 *obj);
static Phalanx_3 *Phalanx_Phalanx(InstanceStruct_gNahLr7d449KlyI8HQN75D
...
static void warning(InstanceStruct_gNahLr7d449KlyI8HQN75D *moduleInstance);
static void b_warning(InstanceStruct_gNahLr7d449KlyI8HQN75D *moduleInstance,
                      char_T varargin_1[14]);
static void emlrt_marshallIn(InstanceStruct_gNahLr7d449KlyI8HQN75D
  *moduleInstance, const mxArray *c_sprintf, const char_T *identifier, char_T y
  [14]);
static void b_emlrt_marshallIn(InstanceStruct_gNahLr7d449KlyI8HQN75D
  *moduleInstance, const mxArray *u, const emlrtMsgIdentifier *parentId, char_T
  y[14]);
static void cgxe_mdl_start(InstanceStruct_gNahLr7d449KlyI8HQN75D *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_gNahLr7d449KlyI8HQN75D
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_gNahLr7d449KlyI8HQN75D
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_gNahLr7d449KlyI8HQN75D
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_gNahLr7d449KlyI8HQN75D
  *moduleInstance);
static const mxArray *emlrt_marshallOut(const Phalanx_3 *u);
static const mxArray *mw__internal__getSimState__fcn
  (InstanceStruct_gNahLr7d449KlyI8HQN75D *moduleInstance);
static void c_emlrt_marshallIn(InstanceStruct_gNahLr7d449KlyI8HQN75D
  *moduleInstance, const mxArray *b_sysobj, const char_T *identifier, Finger_2
  *y);
static void d_emlrt_marshallIn(InstanceStruct_gNahLr7d449KlyI8HQN75D
  *moduleInstance, const mxArray *u, const emlrtMsgIdentifier *parentId,
  Finger_2 *y);
static int32_T e_emlrt_marshallIn(InstanceStruct_gNahLr7d449KlyI8HQN75D
  *moduleInstance, const mxArray *u, const emlrtMsgIdentifier *parentId);
static boolean_T f_emlrt_marshallIn(InstanceStruct_gNahLr7d449KlyI8HQN75D
  *moduleInstance, const mxArray *u, const emlrtMsgIdentifier *parentId);
static real_T g_emlrt_marshallIn(InstanceStruct_gNahLr7d449KlyI8HQN75D
  *moduleInstance, const mxArray *u, const emlrtMsgIdentifier *parentId);
static void h_emlrt_marshallIn(InstanceStruct_gNahLr7d449KlyI8HQN75D
  *moduleInstance, const mxArray *u, const emlrtMsgIdentifier *parentId,
  Phalanx_3 *y);
static ForceNormal i_emlrt_marshallIn(InstanceStruct_gNahLr7d449KlyI8HQN75D
  *moduleInstance, const mxArray *u, const emlrtMsgIdentifier *parentId);
static void j_emlrt_marshallIn(InstanceStruct_gNahLr7d449KlyI8HQN75D
  *moduleInstance, const mxArray *u, const emlrtMsgIdentifier *parentId, real_T
  y[2]);
static boolean_T k_emlrt_marshallIn(InstanceStruct_gNahLr7d449KlyI8HQN75D
  *moduleInstance, const mxArray *b_sysobj_not_empty, const char_T *identifier);
static void mw__internal__setSimState__fcn(InstanceStruct_gNahLr7d449KlyI8HQN75D
  *moduleInstance, const mxArray *st);
static const mxArray *message(InstanceStruct_gNahLr7d449KlyI8HQN75D
  *moduleInstance, const mxArray *b, emlrtMCInfo *location);
static void error(InstanceStruct_gNahLr7d449KlyI8HQN75D *moduleInstance, const
                  mxArray *b, emlrtMCInfo *location);
static const mxArray *b_message(InstanceStruct_gNahLr7d449KlyI8HQN75D
  *moduleInstance, const mxArray *b, const mxArray *c, emlrtMCInfo *location);
static const mxArray *feval(InstanceStruct_gNahLr7d449KlyI8HQN75D
  *moduleInstance, const mxArray *b, const mxArray *c, emlrtMCInfo *location);
static void b_feval(InstanceStruct_gNahLr7d449KlyI8HQN75D *moduleInstance, const
                    mxArray *b, const mxArray *c, emlrtMCInfo *location);
static const mxArray *b_sprintf(InstanceStruct_gNahLr7d449KlyI8HQN75D
  *moduleInstance, const mxArray *b, const mxArray *c, emlrtMCInfo *location);
static const mxArray *c_feval(InstanceStruct_gNahLr7d449KlyI8HQN75D
  *moduleInstance, const mxArray *b, const mxArray *c, const mxArray *d,
  emlrtMCInfo *location);
static void l_emlrt_marshallIn(InstanceStruct_gNahLr7d449KlyI8HQN75D
  *moduleInstance, const mxArray *src, const emlrtMsgIdentifier *msgId, char_T
  ret[14]);
static int32_T m_emlrt_marshallIn(InstanceStruct_gNahLr7d449KlyI8HQN75D
  *moduleInstance, const mxArray *src, const emlrtMsgIdentifier *msgId);
static boolean_T n_emlrt_marshallIn(InstanceStruct_gNahLr7d449KlyI8HQN75D
  *moduleInstance, const mxArray *src, const emlrtMsgIdentifier *msgId);
static real_T o_emlrt_marshallIn(InstanceStruct_gNahLr7d449KlyI8HQN75D
  *moduleInstance, const mxArray *src, const emlrtMsgIdentifier *msgId);
static void p_emlrt_marshallIn(InstanceStruct_gNahLr7d449KlyI8HQN75D
  *moduleInstance, const mxArray *src, const emlrtMsgIdentifier *msgId, real_T
  ret[2]);
static void init_simulink_io_address(InstanceStruct_gNahLr7d449KlyI8HQN75D
  *moduleInstance);
  ...
  *moduleInstance, Finger_2 *obj)
{
  ...
  b_obj->thetaP = 0.31415926535897931;
  c_obj = b_obj;
  flag = (c_obj->isInitialized == 1);
  if (flag) {
    c_obj->TunablePropsChanged = true;
  ...
  b_obj->thetaD = 1.0471975511965976;
  Phalanx_Phalanx(moduleInstance, &b_obj->prox, b_obj->kP, b_obj->lP, b_obj->rP,
                  b_obj->mP, b_obj->thetaP, 1.0);
  Phalanx_Phalanx(moduleInstance, &b_obj->dist, b_obj->kD, b_obj->lD, b_obj->rD,
                  b_obj->mD, b_obj->thetaD, 2.0);
  return b_obj;
}
...
static void cgxe_mdl_start(InstanceStruct_gNahLr7d449KlyI8HQN75D *moduleInstance)
{
  ...
  covrtFcnInit(moduleInstance->covInst, 0, 6, "Finger_eom", 3085, -1, 4737);
  covrtFcnInit(moduleInstance->covInst, 0, 5, "Finger_getPoly", 2880, -1, 3076);
  covrtFcnInit(moduleInstance->covInst, 0, 4, "Finger_fKine", 2393, -1, 2871);
  covrtFcnInit(moduleInstance->covInst, 0, 3, "Finger_rotMat", 2226, -1, 2384);
  covrtFcnInit(moduleInstance->covInst, 0, 2, "Finger_computeJe", 1936, -1, 2217);
  covrtFcnInit(moduleInstance->covInst, 0, 1, "Finger_computeJc", 1628, -1, 1927);
  covrtFcnInit(moduleInstance->covInst, 0, 0, "Finger_Finger", 1043, -1, 1619);
  covrtFcnInit(moduleInstance->covInst, 0, 7, "Finger_stepImpl", 4787, -1, 4939);

  /* Initialize Basic Block Information */
  covrtBasicBlockInit(moduleInstance->covInst, 0, 6, 3133, -1, 4724);
  covrtBasicBlockInit(moduleInstance->covInst, 0, 5, 2921, -1, 3063);
  covrtBasicBlockInit(moduleInstance->covInst, 0, 4, 2482, -1, 2858);
  covrtBasicBlockInit(moduleInstance->covInst, 0, 3, 2299, -1, 2371);
  covrtBasicBlockInit(moduleInstance->covInst, 0, 2, 2019, -1, 2203);
  covrtBasicBlockInit(moduleInstance->covInst, 0, 1, 1709, -1, 1893);
  covrtBasicBlockInit(moduleInstance->covInst, 0, 0, 1087, -1, 1606);
  covrtBasicBlockInit(moduleInstance->covInst, 0, 7, 4855, -1, 4904);
  ...
  /* Initialize Function Information */
  covrtFcnInit(moduleInstance->covInst, 1, 0, "Phalanx_Phalanx", 1233, -1, 1954);

  /* Initialize Basic Block Information */
  covrtBasicBlockInit(moduleInstance->covInst, 1, 4, 1815, -1, 1941);
  covrtBasicBlockInit(moduleInstance->covInst, 1, 3, 1760, -1, 1785);
  covrtBasicBlockInit(moduleInstance->covInst, 1, 2, 1680, -1, 1705);
  covrtBasicBlockInit(moduleInstance->covInst, 1, 1, 1611, -1, 1637);
  covrtBasicBlockInit(moduleInstance->covInst, 1, 0, 1433, -1, 1558);

  /* Initialize If Information */
  covrtIfInit(moduleInstance->covInst, 1, 0, 1401, 1416, 1739, 1802);
  covrtIfInit(moduleInstance->covInst, 1, 1, 1576, 1590, 1655, 1726);
  ...
  *moduleInstance)
{
  ...
  Jc[0] = obj->prox.a;
  Jc[2] = 0.0;
  Jc[1] = obj->dist.a + obj->prox.l * (muDoubleScalarCos(r) - obj->dist.miuC *
    muDoubleScalarSin(t));
  Jc[3] = obj->dist.a;
  ...
  Je[0] = obj->prox.b;
  Je[2] = 0.0;
  Je[1] = obj->dist.b + obj->prox.l * (muDoubleScalarCos(r) - obj->dist.miuE *
    muDoubleScalarSin(t));
  Je[3] = obj->dist.b;
  t = obj->prox.l;
  r = obj->dist.l;
  ...
  d_b[0] = obj->prox.l;
  d_b[1] = 0.0;
  varargin_15[0] = *moduleInstance->u2;
  varargin_15[1] = *moduleInstance->u3;
  ...
  for (i4 = 0; i4 < 2; i4++) {
    ...
    (*moduleInstance->b_y1)[i4] = varargin_15[i4] + r;
  }
  ...
  if (obj->TunablePropsChanged) {
    ...
    emlrtAssign(&i_y, m4);
    error(moduleInstance, message(moduleInstance, i_y, &b_emlrtMCI), &b_emlrtMCI);
  }
  ...
  for (i4 = 0; i4 < 2; i4++) {
    ...
    for (i5 = 0; i5 < 2; i5++) {
      ...
      c_obj[i4] += D[i4 + (i5 << 1)] * thetaDot[i5];
    }
    ...
    for (i5 = 0; i5 < 2; i5++) {
      r += Je[i5 + (i4 << 1)] * c_b[i5];
      varargin_15[i4] += Jc[i5 + (i4 << 1)] * b_b[i5];
    }

    b_C[i4] = ((d_b[i4] + varargin_15[i4]) + r) + Ja[i4] * *moduleInstance->u1;
  }
  ...
  *moduleInstance, const mxArray *b, emlrtMCInfo *location)
{
  ...
  const mxArray *m8;
  pArray = b;
  return emlrtCallMATLABR2012b(moduleInstance->emlrtRootTLSGlobal, 1, &m8, 1,
...
/* CGXE Glue Code */
static void mdlOutputs_gNahLr7d449KlyI8HQN75D(SimStruct *S, int_T tid)
{
  InstanceStruct_gNahLr7d449KlyI8HQN75D *moduleInstance =
    (InstanceStruct_gNahLr7d449KlyI8HQN75D *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_gNahLr7d449KlyI8HQN75D(SimStruct *S)
{
  InstanceStruct_gNahLr7d449KlyI8HQN75D *moduleInstance =
    (InstanceStruct_gNahLr7d449KlyI8HQN75D *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_gNahLr7d449KlyI8HQN75D(SimStruct *S, int_T tid)
{
  InstanceStruct_gNahLr7d449KlyI8HQN75D *moduleInstance =
    (InstanceStruct_gNahLr7d449KlyI8HQN75D *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_gNahLr7d449KlyI8HQN75D(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_gNahLr7d449KlyI8HQN75D *moduleInstance =
    (InstanceStruct_gNahLr7d449KlyI8HQN75D *)cgxertGetRuntimeInstance(S);
...
static void setSimState_gNahLr7d449KlyI8HQN75D(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_gNahLr7d449KlyI8HQN75D *moduleInstance =
    (InstanceStruct_gNahLr7d449KlyI8HQN75D *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_gNahLr7d449KlyI8HQN75D(SimStruct *S)
{
  InstanceStruct_gNahLr7d449KlyI8HQN75D *moduleInstance =
    (InstanceStruct_gNahLr7d449KlyI8HQN75D *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_gNahLr7d449KlyI8HQN75D(SimStruct *S)
{
  InstanceStruct_gNahLr7d449KlyI8HQN75D *moduleInstance =
    (InstanceStruct_gNahLr7d449KlyI8HQN75D *)calloc(1, sizeof
    (InstanceStruct_gNahLr7d449KlyI8HQN75D));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_gNahLr7d449KlyI8HQN75D);
  ssSetmdlInitializeConditions(S, mdlInitialize_gNahLr7d449KlyI8HQN75D);
  ssSetmdlUpdate(S, mdlUpdate_gNahLr7d449KlyI8HQN75D);
  ssSetmdlTerminate(S, mdlTerminate_gNahLr7d449KlyI8HQN75D);
...
static void mdlProcessParameters_gNahLr7d449KlyI8HQN75D(SimStruct *S)
{
}

void method_dispatcher_gNahLr7d449KlyI8HQN75D(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_gNahLr7d449KlyI8HQN75D(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_gNahLr7d449KlyI8HQN75D(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_gNahLr7d449KlyI8HQN75D(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_gNahLr7d449KlyI8HQN75D(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: gNahLr7d449KlyI8HQN75D.\n"
...
mxArray *cgxe_gNahLr7d449KlyI8HQN75D_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
