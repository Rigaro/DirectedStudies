...
static Phalanx_3 *Phalanx_Phalanx(InstanceStruct_6Fp6Co2TWZGurNaXqomZw
...
static void warning(InstanceStruct_6Fp6Co2TWZGurNaXqomZw *moduleInstance);
static void b_warning(InstanceStruct_6Fp6Co2TWZGurNaXqomZw *moduleInstance,
                      char_T varargin_1[14]);
static void emlrt_marshallIn(InstanceStruct_6Fp6Co2TWZGurNaXqomZw
  *moduleInstance, const mxArray *c_sprintf, const char_T *identifier, char_T y
  [14]);
static void b_emlrt_marshallIn(InstanceStruct_6Fp6Co2TWZGurNaXqomZw
  *moduleInstance, const mxArray *u, const emlrtMsgIdentifier *parentId, char_T
  y[14]);
static void cgxe_mdl_start(InstanceStruct_6Fp6Co2TWZGurNaXqomZw *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_6Fp6Co2TWZGurNaXqomZw
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_6Fp6Co2TWZGurNaXqomZw
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_6Fp6Co2TWZGurNaXqomZw *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_6Fp6Co2TWZGurNaXqomZw
  *moduleInstance);
static const mxArray *emlrt_marshallOut(const Phalanx_3 *u);
static const mxArray *mw__internal__getSimState__fcn
  (InstanceStruct_6Fp6Co2TWZGurNaXqomZw *moduleInstance);
static void c_emlrt_marshallIn(InstanceStruct_6Fp6Co2TWZGurNaXqomZw
  *moduleInstance, const mxArray *b_sysobj, const char_T *identifier, Index_2 *y);
static void d_emlrt_marshallIn(InstanceStruct_6Fp6Co2TWZGurNaXqomZw
  *moduleInstance, const mxArray *u, const emlrtMsgIdentifier *parentId, Index_2
  *y);
static int32_T e_emlrt_marshallIn(InstanceStruct_6Fp6Co2TWZGurNaXqomZw
  *moduleInstance, const mxArray *u, const emlrtMsgIdentifier *parentId);
static boolean_T f_emlrt_marshallIn(InstanceStruct_6Fp6Co2TWZGurNaXqomZw
  *moduleInstance, const mxArray *u, const emlrtMsgIdentifier *parentId);
static real_T g_emlrt_marshallIn(InstanceStruct_6Fp6Co2TWZGurNaXqomZw
  *moduleInstance, const mxArray *u, const emlrtMsgIdentifier *parentId);
static void h_emlrt_marshallIn(InstanceStruct_6Fp6Co2TWZGurNaXqomZw
  *moduleInstance, const mxArray *u, const emlrtMsgIdentifier *parentId,
  Phalanx_3 *y);
static ForceNormal i_emlrt_marshallIn(InstanceStruct_6Fp6Co2TWZGurNaXqomZw
  *moduleInstance, const mxArray *u, const emlrtMsgIdentifier *parentId);
static void j_emlrt_marshallIn(InstanceStruct_6Fp6Co2TWZGurNaXqomZw
  *moduleInstance, const mxArray *u, const emlrtMsgIdentifier *parentId, real_T
  y[2]);
static boolean_T k_emlrt_marshallIn(InstanceStruct_6Fp6Co2TWZGurNaXqomZw
  *moduleInstance, const mxArray *b_sysobj_not_empty, const char_T *identifier);
static void mw__internal__setSimState__fcn(InstanceStruct_6Fp6Co2TWZGurNaXqomZw *
  moduleInstance, const mxArray *st);
static const mxArray *message(InstanceStruct_6Fp6Co2TWZGurNaXqomZw
  *moduleInstance, const mxArray *b, const mxArray *c, emlrtMCInfo *location);
static void error(InstanceStruct_6Fp6Co2TWZGurNaXqomZw *moduleInstance, const
                  mxArray *b, emlrtMCInfo *location);
static const mxArray *b_message(InstanceStruct_6Fp6Co2TWZGurNaXqomZw
  *moduleInstance, const mxArray *b, emlrtMCInfo *location);
static const mxArray *feval(InstanceStruct_6Fp6Co2TWZGurNaXqomZw *moduleInstance,
  const mxArray *b, const mxArray *c, emlrtMCInfo *location);
static void b_feval(InstanceStruct_6Fp6Co2TWZGurNaXqomZw *moduleInstance, const
                    mxArray *b, const mxArray *c, emlrtMCInfo *location);
static const mxArray *b_sprintf(InstanceStruct_6Fp6Co2TWZGurNaXqomZw
  *moduleInstance, const mxArray *b, const mxArray *c, emlrtMCInfo *location);
static const mxArray *c_feval(InstanceStruct_6Fp6Co2TWZGurNaXqomZw
  *moduleInstance, const mxArray *b, const mxArray *c, const mxArray *d,
  emlrtMCInfo *location);
static void l_emlrt_marshallIn(InstanceStruct_6Fp6Co2TWZGurNaXqomZw
  *moduleInstance, const mxArray *src, const emlrtMsgIdentifier *msgId, char_T
  ret[14]);
static int32_T m_emlrt_marshallIn(InstanceStruct_6Fp6Co2TWZGurNaXqomZw
  *moduleInstance, const mxArray *src, const emlrtMsgIdentifier *msgId);
static boolean_T n_emlrt_marshallIn(InstanceStruct_6Fp6Co2TWZGurNaXqomZw
  *moduleInstance, const mxArray *src, const emlrtMsgIdentifier *msgId);
static real_T o_emlrt_marshallIn(InstanceStruct_6Fp6Co2TWZGurNaXqomZw
  *moduleInstance, const mxArray *src, const emlrtMsgIdentifier *msgId);
static void p_emlrt_marshallIn(InstanceStruct_6Fp6Co2TWZGurNaXqomZw
  *moduleInstance, const mxArray *src, const emlrtMsgIdentifier *msgId, real_T
  ret[2]);
static void init_simulink_io_address(InstanceStruct_6Fp6Co2TWZGurNaXqomZw
  *moduleInstance);
...
static void cgxe_mdl_start(InstanceStruct_6Fp6Co2TWZGurNaXqomZw *moduleInstance)
{
  ...
  covrtScriptInit(moduleInstance->covInst,
                  "C:\\Users\\Ricardo\\Documents\\Workspace\\Directed Studies\\Simulation\\Index.m",
                  0, 9, 9, 0, 0, 0, 0, 0, 0, 0, 0);

  /* Initialize Function Information */
  covrtFcnInit(moduleInstance->covInst, 0, 7, "Index_eom", 2942, -1, 4718);
  covrtFcnInit(moduleInstance->covInst, 0, 6, "Index_getPoly", 2737, -1, 2933);
  covrtFcnInit(moduleInstance->covInst, 0, 5, "Index_fKine", 2220, -1, 2728);
  covrtFcnInit(moduleInstance->covInst, 0, 4, "Index_rotMat", 2053, -1, 2211);
  covrtFcnInit(moduleInstance->covInst, 0, 3, "Index_computeJe", 1855, -1, 2044);
  covrtFcnInit(moduleInstance->covInst, 0, 2, "Index_computeJc", 1639, -1, 1846);
  covrtFcnInit(moduleInstance->covInst, 0, 1, "Index_Finger", 1042, -1, 1630);
  covrtFcnInit(moduleInstance->covInst, 0, 8, "Index_stepImpl", 4974, -1, 5126);
  covrtFcnInit(moduleInstance->covInst, 0, 0, "Index_Index", 107, -1, 112);

  /* Initialize Basic Block Information */
  covrtBasicBlockInit(moduleInstance->covInst, 0, 7, 2990, -1, 4705);
  covrtBasicBlockInit(moduleInstance->covInst, 0, 6, 2778, -1, 2920);
  covrtBasicBlockInit(moduleInstance->covInst, 0, 5, 2309, -1, 2715);
  covrtBasicBlockInit(moduleInstance->covInst, 0, 4, 2126, -1, 2198);
  covrtBasicBlockInit(moduleInstance->covInst, 0, 3, 1938, -1, 2030);
  covrtBasicBlockInit(moduleInstance->covInst, 0, 2, 1720, -1, 1812);
  covrtBasicBlockInit(moduleInstance->covInst, 0, 1, 1086, -1, 1617);
  covrtBasicBlockInit(moduleInstance->covInst, 0, 8, 5042, -1, 5091);
...
/* CGXE Glue Code */
static void mdlOutputs_6Fp6Co2TWZGurNaXqomZw(SimStruct *S, int_T tid)
{
  InstanceStruct_6Fp6Co2TWZGurNaXqomZw *moduleInstance =
    (InstanceStruct_6Fp6Co2TWZGurNaXqomZw *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_6Fp6Co2TWZGurNaXqomZw(SimStruct *S)
{
  InstanceStruct_6Fp6Co2TWZGurNaXqomZw *moduleInstance =
    (InstanceStruct_6Fp6Co2TWZGurNaXqomZw *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_6Fp6Co2TWZGurNaXqomZw(SimStruct *S, int_T tid)
{
  InstanceStruct_6Fp6Co2TWZGurNaXqomZw *moduleInstance =
    (InstanceStruct_6Fp6Co2TWZGurNaXqomZw *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_6Fp6Co2TWZGurNaXqomZw(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_6Fp6Co2TWZGurNaXqomZw *moduleInstance =
    (InstanceStruct_6Fp6Co2TWZGurNaXqomZw *)cgxertGetRuntimeInstance(S);
...
static void setSimState_6Fp6Co2TWZGurNaXqomZw(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_6Fp6Co2TWZGurNaXqomZw *moduleInstance =
    (InstanceStruct_6Fp6Co2TWZGurNaXqomZw *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_6Fp6Co2TWZGurNaXqomZw(SimStruct *S)
{
  InstanceStruct_6Fp6Co2TWZGurNaXqomZw *moduleInstance =
    (InstanceStruct_6Fp6Co2TWZGurNaXqomZw *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_6Fp6Co2TWZGurNaXqomZw(SimStruct *S)
{
  InstanceStruct_6Fp6Co2TWZGurNaXqomZw *moduleInstance =
    (InstanceStruct_6Fp6Co2TWZGurNaXqomZw *)calloc(1, sizeof
    (InstanceStruct_6Fp6Co2TWZGurNaXqomZw));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_6Fp6Co2TWZGurNaXqomZw);
  ssSetmdlInitializeConditions(S, mdlInitialize_6Fp6Co2TWZGurNaXqomZw);
  ssSetmdlUpdate(S, mdlUpdate_6Fp6Co2TWZGurNaXqomZw);
  ssSetmdlTerminate(S, mdlTerminate_6Fp6Co2TWZGurNaXqomZw);
...
static void mdlProcessParameters_6Fp6Co2TWZGurNaXqomZw(SimStruct *S)
{
}

void method_dispatcher_6Fp6Co2TWZGurNaXqomZw(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_6Fp6Co2TWZGurNaXqomZw(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_6Fp6Co2TWZGurNaXqomZw(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_6Fp6Co2TWZGurNaXqomZw(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_6Fp6Co2TWZGurNaXqomZw(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: 6Fp6Co2TWZGurNaXqomZw.\n"
...
mxArray *cgxe_6Fp6Co2TWZGurNaXqomZw_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
