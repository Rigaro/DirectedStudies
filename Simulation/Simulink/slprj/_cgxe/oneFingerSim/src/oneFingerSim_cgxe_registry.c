...
static mxArray* cgxe_get_supported_modules(void)
{
  ...
  checksumData[0] = 502960265;
  checksumData[1] = 1531573362;
  checksumData[2] = 4127056403;
  checksumData[3] = 1414438957;
  ...
  mxArray* prhs[])
{
...

  {
    ...
    checksumData[0] = 3748698765;
    checksumData[1] = 375970806;
    checksumData[2] = 3063761957;
    checksumData[3] = 2664437285;
...

  {
    ...
    checksumData[0] = 2165855381;
    checksumData[1] = 2834743444;
    checksumData[2] = 1386106111;
    checksumData[3] = 934366892;
...

  {
    ...
    checksumData[0] = 2777640919;
    checksumData[1] = 760791776;
    checksumData[2] = 1018625719;
    checksumData[3] = 1074918568;
  ...
  mxArray * prhs[])
{
  ...
  if (strcmp(tpChksum, "gNahLr7d449KlyI8HQN75D") == 0) {
    extern mxArray *cgxe_gNahLr7d449KlyI8HQN75D_BuildInfoUpdate(void);
    plhs[0] = cgxe_gNahLr7d449KlyI8HQN75D_BuildInfoUpdate();
    return 1;
  }
