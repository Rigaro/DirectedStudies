  ...
  *chartInstance)
{
  ...
  int32_T c9_i16;
  static real_T c9_dv0[4] = { 0.0, 0.2, -0.05, 0.2 };
...
static void c9_info_helper(const mxArray **c9_info)
{
  ...
  sf_mex_addfield(*c9_info, c9_emlrt_marshallOut("clf"), "name", "name", 1);
  sf_mex_addfield(*c9_info, c9_emlrt_marshallOut(""), "dominantType",
                  "dominantType", 1);
  sf_mex_addfield(*c9_info, c9_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/matlab/graphics/clf.m"), "resolved", "resolved",
                  1);
  sf_mex_addfield(*c9_info, c9_b_emlrt_marshallOut(1373933248U), "fileTimeLo",
                  "fileTimeLo", 1);
  ...
  sf_mex_addfield(*c9_info, c9_emlrt_marshallOut("hold"), "name", "name", 2);
  ...
  sf_mex_addfield(*c9_info, c9_emlrt_marshallOut("plot"), "name", "name", 3);
  sf_mex_addfield(*c9_info, c9_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 3);
  sf_mex_addfield(*c9_info, c9_emlrt_marshallOut(
    "[IXMB]$matlabroot$/toolbox/matlab/graph2d/plot"), "resolved", "resolved", 3);
  sf_mex_addfield(*c9_info, c9_b_emlrt_marshallOut(MAX_uint32_T), "fileTimeLo",
                  "fileTimeLo", 3);
  sf_mex_addfield(*c9_info, c9_b_emlrt_marshallOut(MAX_uint32_T), "fileTimeHi",
                  "fileTimeHi", 3);
  ...
  sf_mex_addfield(*c9_info, c9_emlrt_marshallOut("axis"), "name", "name", 4);
  sf_mex_addfield(*c9_info, c9_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 4);
  sf_mex_addfield(*c9_info, c9_emlrt_marshallOut(
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(620983008U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2666675081U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1690496290U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(700076098U);
}
...
mxArray *sf_c9_hybridSysSim_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("KB5X9altXZdOW6qQu3e99D");
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",314,-1,1123);
...
static void mdlSetWorkWidths_c9_hybridSysSim(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3203267393U));
  ssSetChecksum1(S,(2879945206U));
  ssSetChecksum2(S,(208562892U));
  ssSetChecksum3(S,(294014231U));
